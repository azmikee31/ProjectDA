...
function EditMovie() {
  ...
  const onSubmit = (data) => {
    dispatch(
      updateMovieAction(movies?._id, {
        ...data,
        image: imageWithoutTitle,
        titleImage: imageTitle,
        video: videopUrl,
        casts: casts.length > 0 ? casts : movies?.casts,
      })
    );
  };
    ...
    <SideBar>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-6">
          <h2 className="text-xl font-bold">Update Movie"{movies?.name}"</h2>
          ...
          <div className="flex flex-col gap-2 w-full ">
            ...
            <div className={`w-full ${videopUrl && "md:grid-cols-2"} gap-6`}>
              {videopUrl && (
          ...
          <div className="w-full grid lg:grid-cols-2 gap-6 items-start ">
            <div className="w-full">
              ...
              <span className="text-border text-xs">
                if you add new cast the previous cast will be deleted. So you
