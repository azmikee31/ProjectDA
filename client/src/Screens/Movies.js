...
function MoviesPage() {
  ...
  const sameClass = `text-white py-2 px-4 rounded font-semibold border-2 border-subMain`
  //all movies
  ...
  const queries = useMemo(() => {
    const query = {
      ...
      language: language?.title === "Sort By Rates" ? "" : language?.title,
      ...
      <div className="min-height-screen container mx-auto px-2 my-6">
        ...
        </p>
        {
          isLoading ? (
            ...
            movies?.length > 0 ? (
              <>
                <div className="grid sm:mt-10 mt-6 xl:grid-cols-4 2xl:grid-cols-5 lg:grid-cols-3 sm:grid-cols-2 gap-6 hover:border-subMain">
